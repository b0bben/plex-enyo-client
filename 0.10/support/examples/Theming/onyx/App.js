...
enyo.kind({
	...
	components: [
		...
		{kind: "Scroller", flex: 1, components: [
			...
			{kind: "Example", caption: "Input and RichText", components: [
				...
				{kind: "InputBox", layoutKind: "HFlexLayout", components: [
					...
					{kind: "Input", value: "InputBox", styled: false, flex: 1},
					{content: "Right", style: "padding: 0 10px"},
				]},
				{kind: "RoundedInput", value: "Rounded Input", components: [
					{content: "Foo"},
				]},
				{kind: "RoundedInputBox", components: [
					{content: "Left", style: "padding: 0 10px"},
					{kind: "RoundedInput", value: "RoundedInputBox", styled: false, flex: 1},
					{content: "Right", style: "padding: 0 10px"},
				]},
				{kind: "ToolInput", value: "It's a tool", style: "margin: 2px 0;"},
				{kind: "ToolInputBox", style: "margin: 2px 0;", components: [
					{content: "Left", style: "padding: 0 10px"},
					{kind: "ToolInput", value: "ToolInputBox", styled: false, flex: 1},
					{content: "Right", style: "padding: 0 10px"},
				]},
				{kind: "SearchInput", style: "margin: 2px 0;"},
				{kind: "SearchInput", className: "enyo-middle", style: "margin: 2px 0;"},
				{kind: "RoundedSearchInput"},
				{kind: "ToolSearchInput", style: "margin: 2px 0;"}
			]},
			...
			{kind: "Example", caption: "Toolbar", components: [
				...
				{kind: "Toolbar", className: "enyo-toolbar-light", style: "margin: 8px;", components: [
					{kind: "GrabButton"},
					{kind: "Control", content: "Toolbar - Light"}
				]},
		...
		{kind: "Toolbar", components: [
			{kind: "GrabButton"},
			{kind: "Button", caption: "Normal dark button", className: "enyo-button-dark"},
			{caption: "ToolButton"},
			{icon: "images/menu-icon-delete.png"},
			{icon: "images/menu-icon-forward-email.png"},
			{icon: "images/menu-icon-reply.png", toggling: true},
